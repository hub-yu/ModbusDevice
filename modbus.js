 // MODBUS CRC16校验计算
    ...
    */
    ...
    function customJson() {
      ...
      return [
          { name: "广播打开全部", str: JSON.stringify({"slaveId":0, "functionCode":15, "address":0, "number":32, "bytes": 4, "data":[0xff, 0xff, 0xff, 0xff]})},
          { name: "广播关闭全部", str: JSON.stringify({"slaveId":0, "functionCode":15, "address":0, "number":32, "bytes": 4, "data":[0, 0, 0, 0]})},
          { name: "广播获取所有输出", str: JSON.stringify({"slaveId":0, "functionCode":1, "address":0, "number":32})},
          ...
          { name: "打开7", str: JSON.stringify({"slaveId":17, "functionCode":5, "address":6, "number":0xff00})},
          { name: "打开8", str: JSON.stringify({"slaveId":17, "functionCode":5, "address":7, "number":0xff00})},
          ...
          { name: "关闭7", str: JSON.stringify({"slaveId":17, "functionCode":5, "address":6, "number":0})},
          { name: "关闭8", str: JSON.stringify({"slaveId":17, "functionCode":5, "address":7, "number":0})},
